...
@Stateless
@LocalBean
public class PromoLifeCycleReport {
    ...
    public static final int PROMO_STATUS = 20;

    public String generateReport(List<TransPromo> transPromoList, MstReport report) {
        String filePath = null;
        try {
            String fileName = "PromoLifeCycleReport_" + ReportCommonUtil.getCurrentTimeInMiliSeconds() + ".xlsx";
            filePath = PropertyReportUtil.getPropertyString(ReportTypeEnum.PROMOTION_LIFE_CYCLE_RPT) + fileName;


            XSSFWorkbook workbook = new XSSFWorkbook();
            XSSFSheet sheetName = workbook.createSheet("Promotion_LifeCycle_Report");
            ...
            dataCell0.setCellValue("Report : Promotion Life Cycle Report");
