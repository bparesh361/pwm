...
@Stateless
@LocalBean
public class PromoLifeCycleArticleMCReport {
    ...
    public String generateReport(List<TransPromo> transPromoList, MstReport report) {
        ...
        try {
            String fileName = "PromoLifeCycleArticleMCReport_" + ReportCommonUtil.getCurrentTimeInMiliSeconds() + ".xlsx";
            filePath = PropertyReportUtil.getPropertyString(ReportTypeEnum.PROMOTION_LIFE_CYCLE_ARTICLE_MC_RPT) + fileName;


            XSSFWorkbook workbook = new XSSFWorkbook();

            XSSFSheet sheetName = workbook.createSheet("Promo_LifeCycle_ArticleMC_RPT");
            ...
            dataCell0.setCellValue("Report : Promotion Life Cycle Article & MC Report");
