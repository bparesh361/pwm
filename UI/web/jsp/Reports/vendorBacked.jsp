<%-- 
    Document   : vendorBacked
    Created on : May 19, 2014, 3:17:34 PM
    Author     : javals
--%>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function(){
                ...
                jQuery("#reqGrid").jqGrid({
                    url:"getallRequestReportFieldsForVendorBacked",
                    datatype: 'json',
                    width: 875,
                    height:150,
                ...
                '#reqPager',
                {
                    ...
                    onClickButton: function(){                        
                        jQuery("#reqGrid").jqGrid('setGridParam',{url:'getallRequestReportFieldsForVendorBacked',page:1}).trigger("reloadGrid");
                ...
                $("#btnClear").click(function (){
                    ...
                    $('#uploadFile')[0].reset();
                    $("#statusSel").val("-1");
                    jQuery("#reqGrid").jqGrid('setGridParam',{url:"getallRequestReportFieldsForVendorBacked",datatype:'json',page:1}).trigger("reloadGrid");
                });
            ...
            <tr>
                <td>
                    <table  width="30%">
                        <tr>
                            <td align="center">
                                <h1>Vendor Backed Promotions</h1>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td align="center">
                    <table cellspacing="4" cellpadding="4" width="60%">
                        <s:form  id="uploadFile"  action="submitReportRequestVendorBacked" method="POST">
                            ...
                            <tr>
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" >
                                                <s:select name="formVo.categorySel" id="categorySel"  list="categoryMap" headerKey="-1" headerValue="---Select Category---" value="---Select Category---" cssClass="dropdown"/>
                                            </td>
                                        </tr>
                                        <tr><td height="5px" ></td></tr>
                                ...
                                <td>
                                    <table>
                                        ...
                                        <tr><td height="5px" ></td></tr>
                                        <tr id="">
                                            <td  align="right">Vendor Backed</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td align="left">
                                                <s:select name="formVo.tbVB" id="tbVB" list="#{'-1':'ALL','0':'NO', '1':'YES'}"/>
                                            </td>
                                        </tr>
