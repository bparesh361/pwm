                            ...
                            <tr>
                                <td align="center">
                                    <table width="60%">
                                        <tr>
                                            <td align="right" >
                                                <s:submit  id="btnSubmit" name="btnSubmit" value="Submit" cssClass="btn" action="submitdepartmentMaster"></s:submit>
                                                <s:hidden id="txtdeptID" name="txtdeptID" />
                                            </td>
                                            <td align="left">
