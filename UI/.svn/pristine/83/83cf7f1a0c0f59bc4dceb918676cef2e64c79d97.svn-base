...
<html>
    <head>
        ...
        <title>Buy x Get Y @ Discounted Price</title>
...
//                SetXYZSet4ArticleGridDataOnYFilePostFileOnPageLoad();
                ...
                function setMasterRequestGridRowSelectionOnGridCompeleteAfterYFileUpload(){
                ...
                $("#btnAddXArticle").click(function (){
                    ...
                    $("#XarticleGrid").jqGrid('addRowData',tempIndexGridX,{xartNo:articleCode,xartDesc:articleDesc,xmcCode:mcCode,xmcDesc:mcDesc,xqty:qty});
                    resetxArticleDtl();
                ...
                $("#btnAddGYArticle").click(function (){
                    ...
                    $("#YarticleGrid").jqGrid('addRowData',tempIndexgridY,{yartNo:yarticleCode,yartDesc:yarticleDesc,ymcCode:ymcCode,ymcDesc:ymcDesc,yqty:yqty});
                    resetyArticleDtl();
                    tempIndexgridY++;
                });
                // y file upload
                ...
                $("#btnAddZArticle").click(function (){
                    ...
                    $("#ZarticleGrid").jqGrid('addRowData',tempIndexGridZ,{zartNo:zarticleCode,zartDesc:zarticleDesc,zmcCode:zmcCode,zmcDesc:zmcDesc,zqty:zqty});
                    resetZArticleDtl();
                    tempIndexGridZ++;
                });
                //z file upload
                ...
                $("#btnAddSet4Article").click(function (){
                    ...
                    $("#Set4articleGrid").jqGrid('addRowData',tempIndexgridSet4,{set4artNo:articleCode4,set4artDesc:articleDesc4,set4mcCode:mcCode4,set4mcDesc:mcDesc4,set4qty:qty4});
                    resetset4ArticleDtl();
                    tempIndexgridSet4++;
                });
                ...
                $("#btnAddSet5Article").click(function (){
                    ...
                    $("#Set5articleGrid").jqGrid('addRowData',tempIndexgridSet5,{set5artNo:articleCode5,set5artDesc:articleDesc5,set5mcCode:mcCode5,set5mcDesc:mcDesc5,set5qty:qty5});
                    resetset5ArticleDtl();
...
//                    alert("PromoId : "+promoId);
                    ...
                    var problemIdCheck = checkComboSelection("DisConfig", "Discount Config");
                    if(problemIdCheck[0]==false){
                        alert(problemIdCheck[1]);
                        return false;
                    }

                    var checkblank = isBlank(txtdisValue,"Discount Value ");
                    if(checkblank[0]==false){
                        alert(checkblank[1]);
                        $("#txtdisValue").focus();
                        return false;
                    }
                    if(!isNumeric(txtdisValue)){
                ...
                function getXArticleData(){
                    ...
                    if(articleGridIds.length > 0){
                        //alert("Total Qual Grid Data = "+articleGridIds.length);
                        var tempIndex=0;
                        var arr=new Array();
...
//                    var hdnSet5ManualGridData=$("#hdnSet5ManualGridY").val();
                    ...
                    if(hdnXArticleGridData!=undefined && hdnXArticleGridData.length>0 && hdnXArticleGridData!=null){                          
                        ...
                        var articledata=hdnXArticleGridData.split(",");
                           alert("Article Grid length : "+ articledata.length);
                        for(var i=0;i<articledata.length / 5;i++){
                                alert("Article Grid : "+ articledata);
                            ...
                            if(xarticleCode!=undefined && xarticleCode.length>0){
                                $("#XarticleGrid").jqGrid('addRowData',index,{xartNo:xarticleCode,xartDesc:xarticleDesc,xmcCode:xmcCode,xmcDesc:xmcDesc,xqty:xqty});
                                index++;
                            }
                        }
                    }
...
//                                $("#ZarticleGrid").jqGrid('addRowData',index,{zartNo:zarticleCode,zartDesc:zarticleDesc,zmcCode:zmcCode,zmcDesc:zmcDesc,zqty:zqty});
//                                index++;
//                            }
//                        }
//                    }
...
//                                $("#Set4articleGrid").jqGrid('addRowData',index,{set4artNo:set4articleCode,set4artDesc:set4articleDesc,set4mcCode:set4mcCode,set4mcDesc:set4mcDesc,set4qty:set4qty});
//                                index++;
//                            }
//                        }
//                    }
...
//                                $("#Set5articleGrid").jqGrid('addRowData',index,{set5artNo:set5articleCode,set5artDesc:set5articleDesc,set5mcCode:set5mcCode,set5mcDesc:set5mcDesc,set5qty:set5qty});
//                                index++;
//                            }
//                        }
//                    }
                    ...
                    if(hdnYManualGridX!=undefined && hdnYManualGridX.length>0 && hdnYManualGridX!=null){
                        ...
                        for(var i=0;i<articledata.length/5;i++){
                            ...
                            if(yarticleCode!=undefined && yarticleCode.length>0){
                                $("#YarticleGrid").jqGrid('addRowData',index,{yartNo:yarticleCode,yartDesc:yarticleDesc,ymcCode:ymcCode,ymcDesc:ymcDesc,yqty:yqty});
                                index++;
                            }
                        }
                    }
                ...
                function callLoadReqAndSubReqGrid(){
                    ...
                    jQuery("#reqGrid").jqGrid({
                        ...
                        caption:"",  onSelectRow: function(id) {
                            ...
                            setMasterRequestGridRowSelectionOnGridCompeleteAfterYFileUpload();
    ...
    <body>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="f14" align="center">
            <tr>
                <td><h1>Buy X Get Y @ Discounted Price</h1></td>
            </tr>
                                            ...
                                            <div id="BXtabMaster" class="tabbed_box">
                                                ...
                                                <div id="BX_sub_content_2" class="content">
                                                    <table id="BX_uploadTable"  align="center" cellpadding="2" cellspacing="4">
                                                        <s:form id="xuploadFile"  action="uploadbxgyDiscxarticle_action" method="post" enctype="multipart/form-data">
                                            ...
                                            <div id="GYtabMaster" class="tabbed_box">
                                                ...
                                                <div id="GY_sub_content_2" class="content">
                                                    <table id="GY_uploadTable"  align="center" cellpadding="2" cellspacing="4">
                                                        <s:form id="yuploadFile"  action="uploadbxgyDiscYarticle_action" method="post" enctype="multipart/form-data">
                                            ...
                                            <div id="BZtabMaster" class="tabbed_box">
                                                ...
                                                <div id="BZ_sub_content_2" class="content">
                                                    <table id="BZ_uploadTable"  align="center" cellpadding="2" cellspacing="4">
                                                        <s:form id="zuploadFile"  action="uploadbxgyDiscZarticle_action" method="post" enctype="multipart/form-data">
                                            ...
                                            <div id="Set4tabMaster" class="tabbed_box">
                                                ...
                                                <div id="Set4_sub_content_2" class="content">
                                                    <table id="Set4_uploadTable"  align="center" cellpadding="2" cellspacing="4">
                                                        <s:form id="Set4uploadFile"  action="uploadbxgyDiscSet4article_action" method="post" enctype="multipart/form-data">
                                            ...
                                            <div id="Set5tabMaster" class="tabbed_box">
                                                ...
                                                <div id="Set5_sub_content_2" class="content">
                                                    <table id="Set5_uploadTable"  align="center" cellpadding="2" cellspacing="4">
                                                        <s:form id="Set5uploadFile"  action="uploadbxgyDiscSet5article_action" method="post" enctype="multipart/form-data">
...
<input type="hidden" name="createBXGYFormVO.manualdiscGridData" id="manualdiscGridData" />
                                                            ...
                                                            <!--                                                            <input align="left" type="button" id="btnSave" name="btnSave"  Value="Save" Class="btn" />-->
                                                            <s:submit align="left" id="btnSave" name="btnSave"  value="Save" cssClass="btn" action="submitBXGXDiscDtl"/>
                                                        </td>
<!--                                                        <td align="center">
                                                            <input align="left" type="button" id="btnBXGYSaveNext" name="btnBXGYSaveNext"  Value="Save & Next" Class="btn" />
                                                        </td>-->
