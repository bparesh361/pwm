 ...
 * @author ajitn
 */
public class FlatDiscountFormVO {
...
private String isInitiatorRedirect,SessionmstPromoId;
    ...
    public String getConversionGrowth() {
        return conversionGrowth;
    }

    public void setConversionGrowth(String conversionGrowth) {
