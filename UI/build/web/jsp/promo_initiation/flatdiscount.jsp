                ...
                <tr>
                    <td>
                        <table id="BuyXGetYTable" width="90%" border="0" align="center" cellpadding="2" cellspacing="4">
                            <s:form id="createFlatDiscount" action="createFlatDiscount_action" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="flatDiscountVO.isManualEntry" id="isManualEntry" />                                
                                <s:hidden name="flatDiscountVO.mstPromoId" id="mstPromoId" value="%{flatDiscountVO.mstPromoId}"/>
                                <input type="hidden" name="flatDiscountVO.manualArticleData" id="XarticleGridData" />
                                <s:hidden id="hdnisUploadFileError" name="flatDiscountVO.isUploadFileError" value="%{flatDiscountVO.isUploadFileError}"/>
                                <s:hidden  name="flatDiscountVO.isInitiatorRedirect" id="isInitiatorRedirect" value="%{flatDiscountVO.isInitiatorRedirect}" />
                                <s:hidden  name="flatDiscountVO.SessionmstPromoId" id="SessionmstPromoId" value="%{flatDiscountVO.SessionmstPromoId}" />
                                <tr>
                                    <td align="left">
                                        <table width="60%" >
                                            <tr>
                                                            ...
                                                            <table id="BX_uploadTable"  align="center" cellpadding="2" cellspacing="4">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center" id="tdErrorFile">                                                                        
                                                                        <s:a  href="%{flatDiscountVO.errorfilePath}" class="downloadError" id="downloadErrorFile" > Status File </s:a>
                                                                    </td>
                                                                </tr>
                                    ...
                                    <td align="center">
                                        <table width="70%" border="0" align="center" cellpadding="2" cellspacing="4">
                                            <tr>
                                                ...
                                                <td>
                                                    <s:select headerKey="-1" headerValue="---Select Discount---" list="#{'0':'Value Off','1':'Percentage Off','2':'Flat Discount'}" id="txtDisConfig" name="flatDiscountVO.discountConfig" value="%{flatDiscountVO.discountConfig}" cssClass="dropdown"/>
                                                </td>
                                                <td>Value</td>
                                                <td><s:textfield id="txtdisValue" name="flatDiscountVO.discountConfigValue" value="%{flatDiscountVO.discountConfigValue}" /> </td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <table width="60%" border="0" align="center" cellpadding="2" cellspacing="4">
                                            <tr>
                                                ...
                                                <td><s:textfield id="txtBXGYmargin" name="flatDiscountVO.marginAchivement" value="%{flatDiscountVO.marginAchivement}" /></td>
                                            </tr>
                                            <tr>
                                                <td>Growth in Ticket size</td>
                                                <td><s:textfield id="txtBXGYgrowth" name="flatDiscountVO.ticketSizeGrowth" value="%{flatDiscountVO.ticketSizeGrowth}" /></td>
                                            </tr>
                                            <tr>
                                                <td>Sell thru – v/s quantity</td>
                                                <td><s:textfield id="txtBXGYsellQty" name="flatDiscountVO.sellQty" value="%{flatDiscountVO.sellQty}" /></td>
                                            </tr>
                                            <tr>
                                                <td>Growth in conversions</td>
                                                <td><s:textfield id="txtBXGYgrowthConver" name="flatDiscountVO.conversionGrowth" value="%{flatDiscountVO.conversionGrowth}" /></td>
                                            </tr>
                                            <tr>
                                                <td>Sales Growth – both in quantity and value</td>
                                                <td><s:textfield id="txtBXGYsalegrowth" name="flatDiscountVO.qtyValueSellGrowth" value="%{flatDiscountVO.qtyValueSellGrowth}" /></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="4">
                                                        <tr>
                                                            <td>Valid From</td>
                                                            <td><s:textfield id="txtBXGYFrom" name="flatDiscountVO.validFrom" value="%{flatDiscountVO.validFrom}" /></td>
                                                            <td>Valid To</td>
                                                            <td><s:textfield id="txtBXGYTo" name="flatDiscountVO.validTo" value="%{flatDiscountVO.validTo}" /></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Remarks</td>
                                                <td ><textarea id="txtremarks" name="flatDiscountVO.txtRemarks"  rows="3" cols="25" style="width: 70%;height: 20%"></textarea></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
