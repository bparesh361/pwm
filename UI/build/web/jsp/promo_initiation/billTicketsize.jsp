...
<html>
    <head>
        ...
        <title>Ticket Size ( Bill Level)</title>
    ...
    <body>
        ...
        <div id="middle_cont">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="f14" align="center">
                ...
                <tr>
                    <td><h1>Ticket Size ( Bill Level)</h1></td>
                </tr>
                <tr>
                    <td  align="center">
                ...
                <tr>
                    <td>
                        <table id="BuyXGetYTable" width="90%" border="0" align="center" cellpadding="2" cellspacing="4">
                            <s:form id="createTicketSize" action="createBillLevelTicket_action" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="ticketSizeVO.isManualEntry" id="isManualEntry" />
                                <s:hidden name="ticketSizeVO.mstPromoId" id="mstPromoId" value="%{ticketSizeVO.mstPromoId}"/>
                                <input type="hidden" name="ticketSizeVO.manualArticleData" id="XarticleGridData" />
                                <s:hidden id="hdnisUploadFileError" name="ticketSizeVO.isUploadFileError" value="%{ticketSizeVO.isUploadFileError}"/>
                                 <s:hidden  name="ticketSizeVO.isInitiatorRedirect" id="isInitiatorRedirect" value="%{ticketSizeVO.isInitiatorRedirect}" />
                                                            <s:hidden  name="ticketSizeVO.SessionmstPromoId" id="SessionmstPromoId" value="%{ticketSizeVO.SessionmstPromoId}" />
                                <tr>
                                    <td align="left">
                                        <table width="60%" >
                                            <tr>
                                                        ...
                                                        <div id="content_1" class="content" >
                                                            <table id="BX_manualTable" width="100%" border="0" align="center" cellpadding="2" cellspacing="4">
                                                                <tr>
                                                                    ...
                                                                    <td align="left">
                                                                        <input type="button" name="btnValidateArticle" id="btnValidateArticle" value="Validate" class="btn"/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td align="left">
                                                                        <input type="button" name="btnAddArticle" id="btnAddArticle" value="Add" class="btn" disabled/>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <table id="BX_uploadTable"  align="center" cellpadding="2" cellspacing="4">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center" id="tdErrorFile">
                                                                        <s:a  href="%{ticketSizeVO.errorfilePath}" class="downloadError" id="downloadErrorFile" > Status File </s:a>
                                                                    </td>
                                                                </tr>
                                    ...
                                    <td align="center">
                                        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="4">
                                            <tr>
                                                ...
                                                <td><s:textfield id="txtbuyWortAmt" name="ticketSizeVO.buyWorthAmt" value="%{ticketSizeVO.buyWorthAmt}" /></td>
                                                <td>Discount amount</td>
                                                <td><s:textfield id="txtdisAmt" name="ticketSizeVO.discountAmt" value="%{ticketSizeVO.discountAmt}" /></td>
                                                <td>Discount Config   </td>
                                                <td>
                                                    <s:select headerKey="-1" headerValue="---Select Discount---" list="#{'0':'Value Off','1':'Percentage Off','2':'Flat Discount'}" id="txtDisConfig" name="ticketSizeVO.discountConfig" value="%{ticketSizeVO.discountConfig}" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table width="60%" border="0" align="center" cellpadding="2" cellspacing="4">
                                            <tr>
                                                ...
                                                <td><s:textfield id="txtBXGYmargin" name="ticketSizeVO.marginAchivement" value="%{ticketSizeVO.marginAchivement}" /></td>
                                            </tr>
                                            <tr>
                                                <td>Growth in Ticket size</td>
                                                <td><s:textfield id="txtBXGYgrowth" name="ticketSizeVO.ticketSizeGrowth" value="%{ticketSizeVO.ticketSizeGrowth}" /></td>
                                            </tr>
                                            <tr>
                                                <td>Sell thru – v/s quantity</td>
                                                <td><s:textfield id="txtBXGYsellQty" name="ticketSizeVO.sellQty" value="%{ticketSizeVO.sellQty}" /></td>
                                            </tr>
                                            <tr>
                                                <td>Growth in conversions</td>
                                                <td><s:textfield id="txtBXGYgrowthConver" name="ticketSizeVO.conversionGrowth" value="%{ticketSizeVO.conversionGrowth}" /></td>
                                            </tr>
                                            <tr>
                                                <td>Sales Growth – both in quantity and value</td>
                                                <td><s:textfield id="txtBXGYsalegrowth" name="ticketSizeVO.qtyValueSellGrowth" value="%{ticketSizeVO.qtyValueSellGrowth}" /></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="4">
                                                        <tr>
                                                            <td>Valid From</td>
                                                            <td><s:textfield id="txtBXGYFrom" name="ticketSizeVO.validFrom" value="%{ticketSizeVO.validFrom}" /></td>
                                                            <td>Valid To</td>
                                                            <td><s:textfield id="txtBXGYTo" name="ticketSizeVO.validTo" value="%{ticketSizeVO.validTo}" /></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Remarks</td>
                                                <td ><textarea id="txtremarks" name="ticketSizeVO.txtRemarks"  rows="3" cols="25" style="width: 70%;height: 20%"></textarea></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
