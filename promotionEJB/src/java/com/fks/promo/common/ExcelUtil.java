...
//        dataRow = hssfSheet.createRow(rowNum);
        dataRow = hssfSheet.getRow(rowNum);
        if (dataRow == null) {
            dataRow = hssfSheet.createRow(rowNum);
        }
        ...
        try {
            double doubleValue = Double.parseDouble(headerName);
...
//            System.out.println("---- not a double value");
    ...
    public static void fillCell(int rowNum, int colNum, double headerName, XSSFRow dataRow, XSSFCell cell, XSSFSheet hssfSheet, XSSFCellStyle cellStyle) {
        dataRow = hssfSheet.getRow(rowNum);
        if (dataRow == null) {
            dataRow = hssfSheet.createRow(rowNum);
        }
